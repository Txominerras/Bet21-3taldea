...
public class DeleteEventGUI extends JFrame {
	...
	private JButton jButtonDelete = new JButton(ResourceBundle.getBundle("Etiquetas").getString("DeleteEvent"));
	...
	private void jbInit() throws Exception {
		...
		jButtonDelete.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		jButtonDelete.setEnabled(false);
		jComboBoxEvents.setFont(new Font("Tahoma", Font.PLAIN, 14));
		
		jComboBoxEvents.setModel(modelEvents);
		jComboBoxEvents.setBounds(new Rectangle(290, 137, 334, 35));
		jLabelListOfEvents.setFont(new Font("Tahoma", Font.PLAIN, 18));
		jLabelListOfEvents.setBounds(new Rectangle(290, 66, 277, 41));
		...
		jButtonDelete.setBounds(new Rectangle(67, 376, 198, 53));
		jButtonDelete.setEnabled(false);
		...
		jButtonClose.setBounds(new Rectangle(356, 376, 184, 53));
		...
		jLabelMsg.setBounds(new Rectangle(39, 290, 501, 35));
		jLabelMsg.setForeground(Color.red);
		jLabelError.setFont(new Font("Tahoma", Font.PLAIN, 18));
		// jLabelMsg.setSize(new Dimension(305, 20));

		jLabelError.setBounds(new Rectangle(39, 224, 501, 35));
