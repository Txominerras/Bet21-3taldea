...
public class CreateQuestionGUI extends JFrame {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jComboBoxEvents.setBounds(new Rectangle(291, 108, 354, 37));
		jLabelListOfEvents.setFont(new Font("Tahoma", Font.PLAIN, 18));
		jLabelListOfEvents.setBounds(new Rectangle(291, 54, 354, 46));
		jLabelQuery.setFont(new Font("Tahoma", Font.PLAIN, 18));
		jLabelQuery.setBounds(new Rectangle(59, 220, 140, 37));
		jTextFieldQuery.setFont(new Font("Tahoma", Font.PLAIN, 14));
		jTextFieldQuery.setBounds(new Rectangle(221, 220, 424, 37));
		jLabelMinBet.setFont(new Font("Tahoma", Font.PLAIN, 18));
		jLabelMinBet.setBounds(new Rectangle(59, 280, 140, 37));
		jTextFieldPrice.setFont(new Font("Tahoma", Font.PLAIN, 18));
		jTextFieldPrice.setBounds(new Rectangle(221, 280, 205, 37));

		jCalendar.setBounds(new Rectangle(40, 50, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));
		jButtonCreate.setFont(new Font("Tahoma", Font.PLAIN, 18));

		jButtonCreate.setBounds(new Rectangle(80, 404, 225, 46));
		...
		jButtonClose.setBounds(new Rectangle(437, 413, 140, 37));
		...
		jLabelMsg.setBounds(new Rectangle(100, 341, 467, 37));
		jLabelMsg.setForeground(Color.red);
		jLabelError.setFont(new Font("Tahoma", Font.PLAIN, 18));
		// jLabelMsg.setSize(new Dimension(305, 20));

		jLabelError.setBounds(new Rectangle(100, 372, 457, 37));
