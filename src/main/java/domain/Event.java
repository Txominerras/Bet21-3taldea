...
public class Event implements Serializable {
	...
	public Event(Event e, Date date) {
		this.eventDate = date;
	...
	public boolean hasQuestions() {
		if(this.getQuestions().isEmpty()) return false;
		return true;
	}
	public boolean alreadyCreated(String description, Date date) {
		if(this.description.equals(description) && this.eventDate.equals(date))
			return true; //event already created
		return false; //event not created
	}
